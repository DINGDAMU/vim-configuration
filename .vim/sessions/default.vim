...
nnoremap ,j :AnyJump
nnoremap <silent> ,tt :call neoterm#map_do()
...
noremap <SNR>30_DashGlobalSearch :Dash!
noremap <SNR>30_DashSearch :Dash
...
set runtimepath+=~/.vim/plugged/calendar-vim
set runtimepath+=~/.vim/plugged/vim-p4-syntax
...
set runtimepath+=/usr/local/share/vim/vim90/pack/dist/opt/termdebug
...
set whichwrap=b,s,<,>,,]
set wildignore=.svn,.git,*.swp,*.bak,*~,*.o,*.a,*.pyc
set wildmenu
...
badd +0 merge-two-lists/mergeTwoLists.py
argglobal
%argdel
$argadd merge-two-lists/mergeTwoLists.py
edit merge-two-lists/mergeTwoLists.py
argglobal
setlocal keymap=
setlocal autoindent
setlocal backupcopy=
...
setlocal cinoptions=:0,l1,g0,t0,(0,(s
